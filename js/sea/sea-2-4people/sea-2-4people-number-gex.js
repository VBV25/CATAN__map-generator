...
generateNumberGexBtn.onclick = function() {
    ...
    function numberCheckGex1() {
        ...
        for (i = 0; i < gexNumberArray.length; i++) {
            ...
            if (comparisonNumberFilledGex == false) {
                ...
                if (gex1.classList.contains('block4')) {} else {
                    let indexAllNum;
                    gexNumberArray.find((item, index) => {
    ...
    function numberCheckGex3() {
        ...
        for (i = 0; i < gexNumberArray.length; i++) {
            ...
            if (comparisonNumberFilledGex == false) {
                //Функция удаления из масива
                if (gex3.classList.contains('block4')) {} else {
                    let indexAllNum;
                    gexNumberArray.find((item, index) => {
    ...
    function numberCheckGex4() {
        ...
        for (let i = 0; i < gexNumberArray.length; i++) {
            ...
            if (comparisonNumberFilledGex == false) {
                //Функция удаления из масива
                if (gex4.classList.contains('block4')) {} else {
                    let indexAllNum;
                    gexNumberArray.find((item, index) => {
    ...
    function numberCheckGex8() {
        ...
        for (i = 0; i < gexNumberArray.length; i++) {
            ...
            if (comparisonNumberFilledGex == false) {
                //Функция удаления из масива
                if (gex8.classList.contains('block4')) {} else {
                    let indexAllNum;
                    gexNumberArray.find((item, index) => {
    ...
    function numberCheckGex12() {
        ...
        for (i = 0; i < gexNumberArray.length; i++) {
            ...
            if (comparisonNumberFilledGex == false) {
                ...
                //Функция удаления из масива
                if (gex12.classList.contains('block4')) {} else {
                    let indexAllNum;
                    gexNumberArray.find((item, index) => {
    ...
    function numberCheckGex13() {
        ...
        for (i = 0; i < gexNumberArray.length; i++) {
            ...
            if (comparisonNumberFilledGex == false) {
                //Функция удаления из масива
                if (gex13.classList.contains('block4')) {} else {
                    let indexAllNum;
                    gexNumberArray.find((item, index) => {
    ...
    function numberCheckGex16() {
        ...
        for (i = 0; i < gexNumberArray.length; i++) {
            ...
            if (comparisonNumberFilledGex == false) {
                //Функция удаления из масива
                if (gex16.classList.contains('block4')) {} else {
                    let indexAllNum;
                    gexNumberArray.find((item, index) => {
    ...
    function numberCheckGex17() {
        ...
        for (i = 0; i < gexNumberArray.length; i++) {
            ...
            if (comparisonNumberFilledGex == false) {
                //Функция удаления из масива
                if (gex17.classList.contains('block4')) {} else {
                    let indexAllNum;
                    gexNumberArray.find((item, index) => {
    ...
    function numberCheckGex18() {
        ...
        for (i = 0; i < gexNumberArray.length; i++) {
            ...
            if (comparisonNumberFilledGex == false) {
                ...
                //Функция удаления из масива
                if (gex18.classList.contains('block4')) {} else {
                    let indexAllNum;
                    gexNumberArray.find((item, index) => {
    ...
    function numberCheckGex19() {
        ...
        for (i = 0; i < gexNumberArray.length; i++) {
            ...
            if (comparisonNumberFilledGex == false) {
                //Функция удаления из масива
                if (gex19.classList.contains('block4')) {} else {
                    let indexAllNum;
                    gexNumberArray.find((item, index) => {
    ...
    numberCheckGex10();
    //Функция удаления из масива
    if (gex10.classList.contains('block4')) {} else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
    ...
    numberCheckGex5();
    //Функция удаления из масива
    if (gex5.classList.contains('block4')) {} else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
    ...
    numberCheckGex6();
    //Функция удаления из масива
    if (gex6.classList.contains('block4')) {} else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
    ...
    numberCheckGex11();
    //Функция удаления из масива
    if (gex11.classList.contains('block4')) {} else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
    ...
    numberCheckGex15();
    //Функция удаления из масива
    if (gex15.classList.contains('block4')) {} else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
    ...
    numberCheckGex14();
    //Функция удаления из масива
    if (gex14.classList.contains('block4')) {} else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
    ...
    numberCheckGex9();
    //Функция удаления из масива
    if (gex9.classList.contains('block4')) {} else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
