...
const gexNumberBaseArray = [4, 5, 6, 8, 9, 10, 3, 11, 4, 5, 6, 8, 9, 10, 5, 6, 8, 9, 4];
let gexNumberArray = gexNumberBaseArray.slice(0)
const numArrAdditionalBase = [10, 5, 9, 6, 8, 4, 3, 11]
...
generateNumberGexBtn.onclick = function () {
    ...
    randomNumberCheckGex(gex10)
    delleteNumberFromArray(gex10)
    //-----1----
    gettingNewValuesGexNumber()
    randomNumberCheckGex(gex5, gexNumber10)
    delleteNumberFromArray(gex5)
    //-----2----
    gettingNewValuesGexNumber()
    randomNumberCheckGex(gex6, gexNumber5, gexNumber10)
    delleteNumberFromArray(gex6)
    //-----3----
    gettingNewValuesGexNumber()
    randomNumberCheckGex(gex11, gexNumber6, gexNumber10)
    delleteNumberFromArray(gex11)
    //-----4----
    gettingNewValuesGexNumber()
    randomNumberCheckGex(gex15, gexNumber11, gexNumber10)
    delleteNumberFromArray(gex15)
    //----5------
    gettingNewValuesGexNumber()
    randomNumberCheckGex(gex14, gexNumber15, gexNumber10)
    delleteNumberFromArray(gex14)
    //-----6----
    gettingNewValuesGexNumber()
    randomNumberCheckGex(gex9, gexNumber5, gexNumber14, gexNumber10)
