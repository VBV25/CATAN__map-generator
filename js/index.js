...
generateNumberGexBtn.onclick = function() {
    ...
    clayGexArray.forEach(function(element) {
        ...
        // console.log('новый общий массив');
    ...
    if (gex1.classList.contains('block4')) { return } else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
    ...
    numberCheckGex2()
        //Функция удаления из масива
    if (gex2.classList.contains('block4')) { return } else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
            if (item == gex1.children[0].textContent) {
                indexAllNum = index;
    ...
    numberCheckGex3()
        //Функция удаления из масива
    if (gex3.classList.contains('block4')) { return } else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
            if (item == gex1.children[0].textContent) {
                indexAllNum = index;
    ...
    numberCheckGex4()
        //Функция удаления из масива
    if (gex4.classList.contains('block4')) { return } else {
        let indexAllNum;
        gexNumberArray.find((item, index) => {
            if (item == gex1.children[0].textContent) {
                indexAllNum = index;
